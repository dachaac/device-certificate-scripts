...
openssl req -new -config openssl.cnf -sha256 -nodes -subj "/C=FI/O=Service/CN=IoT Device/serialNumber=K1234567" -key IOTDEVICE-K1234567.key -passin file:IOTDEVICE-K1234567.key.password -out IOTDEVICE-K1234567.csr
